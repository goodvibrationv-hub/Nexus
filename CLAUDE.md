...
+ elagage_guide.js + amenagement.js + dom_ateliers.js + occitan_phrases.js + bienetre.js + noeuds.js + app.js dans template.html → `nexus_app_vN.html`). Valider : `node check.js`,
