 ...
 *
 * Vérifie :
 * - 103 nœuds (79 course + 24 safety) répartis dans 14 domaines
...
if (allNodes.length !== 103) err(`Attendu 103 nœuds, trouvé ${allNodes.length}`);
if (courses.length  !== 79)  err(`Attendu 79 'course', trouvé ${courses.length}`);
