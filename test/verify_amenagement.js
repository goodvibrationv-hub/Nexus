...
function loadApp(env){ for(const f of ['data_core.js','content_courses.js','cards.js','amenagement.js','bienetre.js','noeuds.js','app.js']) vm.runInContext(fs.readFileSync(P(f),'utf8'),env.ctx,{filename:f}); }
...
ok('M7 — compteur : 18 domaines', R.domainCount.textContent==='18 domaines');
