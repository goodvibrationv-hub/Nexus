...
ok('L2 — sous-titre nœuds maîtrisés', /10 nœuds maîtrisés sur 96/.test(R.lvlSub.textContent));
...
ok('V1 — victoire nœuds maîtrisés 10/96', /10 \/ 96/.test(win)&&/nœuds maîtrisés/.test(win));
...
ok('G1 — nœuds à débloquer 86', /86<\/span><span class="l">nœuds à débloquer/.test(gap));
