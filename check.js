 ...
 *
 * Vérifie :
 * - 110 nœuds (86 course + 24 safety) répartis dans 15 domaines
...
if (allNodes.length !== 110) err(`Attendu 110 nœuds, trouvé ${allNodes.length}`);
if (courses.length  !== 86)  err(`Attendu 86 'course', trouvé ${courses.length}`);
