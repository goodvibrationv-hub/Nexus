...
ok('L2 — sous-titre nœuds maîtrisés', /10 nœuds maîtrisés sur 79/.test(R.lvlSub.textContent));
...
ok('V1 — victoire nœuds maîtrisés 10/79', /10 \/ 79/.test(win)&&/nœuds maîtrisés/.test(win));
...
ok('G1 — nœuds à débloquer 69', /69<\/span><span class="l">nœuds à débloquer/.test(gap));
